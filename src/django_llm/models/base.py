...
class LLMProvider(models.Model):
    ...
    def get_available_models(cls, provider_name: str) -> list:
        ...
        return []  # TODO: Implement model registry lookup
    ...
    def validate_model(self) -> bool:
        ...
        return True  # TODO: Implement model validation

    def save(self, *args, **kwargs):
        """Override save to validate model."""
        if not self.validate_model():
            raise ValueError(f"Invalid model {self.model} for provider {self.name}")
